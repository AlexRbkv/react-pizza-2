...
import { clearCart, cartSelector } from '../redux/cartSlice/cartSlice';

const Cart: React.FC = () => {
  const dispatch = useDispatch();
  const { items, count, totalPrice } = useSelector(cartSelector);
      ...
      <div className="container container--cart">
        <div className="cart">
          ...
          <div className="cart__content-items">
            {
              items.map((item: any) => <CartItem key={item.id} data={item}/>)
            }
          </div>
